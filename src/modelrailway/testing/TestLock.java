...
public class TestLock {
	...
	@Test public void testLock2(){
		...
		Section diamondSec = new Section(new ArrayList<Track>());
		Section diamondSec2 = new Section(new ArrayList<Track>());
		Track diamondCrossing = new Crossing(straight0, null, straight1, null, diamondSec, diamondSec2, 100, 100);
		diamondSec.add(diamondCrossing);
		diamondSec2.add(diamondCrossing);
	...
	@Test public void testLock3(){
		...
		ctl.tryLocking(new Event.SectionChanged(num,true), true); // move out of a detection section into num. 
	...
	/**
	 * Test that both parts of a diamond crossing are locked when entering a diamond crossing. 
	 */
	@Test public void testLock4(){
		
		Section diamondSec = new Section(new ArrayList<Track>());
		Section diamondSec2 = new Section(new ArrayList<Track>());
		Track diamondCrossing = new Crossing(null, null, null, null, diamondSec, diamondSec2, 100, 100); // first make the crossing.
		
		// then attach 
		Section straightSec = new Section(new ArrayList<Track>());
		Track straight0 = new Straight(null, diamondCrossing, straightSec, 100);
		straightSec.add(straight0);
		
		Section straightSec0 = new Section(new ArrayList<Track>());
		Track straight1 = new Straight(null,diamondCrossing,straightSec0, 100);
		straightSec0.add(straight1);
		...
		diamondSec.setSectionNumber(4);
		diamondSec2.setSectionNumber(2);
		straightSec.setSectionNumber(1);
		straightSec0.setSectionNumber(3);
		
		Train tr = new Train(2, true);
		Map<Integer,Train> trains = new HashMap<Integer,Train>();
		trains.put(0,tr);
		
		Map<Integer,Section> sections = new HashMap<Integer,Section>();
		sections.put(4,diamondSec);
		sections.put(2,diamondSec2);
		sections.put(1, straightSec);
		sections.put(3, straightSec0);
